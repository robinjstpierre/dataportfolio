...
- Databases: MySQL,SQLite,PostgresSQL
...
## Work Experience
**KPMG LLP - Business Analyst - Orlando, FL. (_June 2025-Present_)**
- Analyst as part of KPMG’s Corporate Tax Shared Services practice by analyzing and processing client tax and financial data in accordance with firm procedures, quality standards, and deadlines. Responsible for reviewing client documentation, identifying data inconsistencies, performing data entry, and supporting the preparation of corporate tax deliverables using KPMG tax technology platforms. Operating in a high-volume, deadline-driven environment requiring strong attention to detail, documentation accuracy, and professional communication across cross-functional teams.
